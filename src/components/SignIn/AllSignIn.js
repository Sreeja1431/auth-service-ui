...
const SignIn = () => {
  ...
  const handleLogin = () => {
    ...
    if (resultList.length !== 0) {
      ...
      .then((response)=>{
        window.location.href='http://localhost:8090/landPage'
  ...
  const onClickHandle = () => {
    axios.get('http://localhost:3000/auth/authorization')
      .then(response=>{
  ...
  return (
    <div id="sign-in">
      ...
      <div className="sign-in">
        ...
        <div className="login-div">
        <NavLink to='/loginWithOTP'>Login with OTP on mail</NavLink>
          {/* <a href='/loginWithOTP'>Login with OTP on mail</a> */}
        </div>
        <div className="login-div">
